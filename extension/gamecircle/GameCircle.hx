...
import com.samcodes.gamecircle.gc.ConnectionHandler;
import com.samcodes.gamecircle.gc.GamesClient;
...
class GameCircle
{
  ...
  private static function initJNI()
  {
    if(_start == null)
    {
      _start = JNI.createStaticMethod("com/samcodes/gamecircle/GameCircle",
          "start", "(Lorg/haxe/lime/HaxeObject;)V");
    }

    if(_isAvailable == null)
    {
      _isAvailable = JNI.createStaticMethod("com/samcodes/gamecircle/GameCircle",
          "isAvailable", "()Z");
    }
  }
